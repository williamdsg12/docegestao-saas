...
async function applyMigration() {
  const sqlPath = path.join(__dirname, 'migration_v34_campaign_queue.sql');
  const sql = fs.readFileSync(sqlPath, 'utf8');
  console.log("Attempting to apply Migration V34...");
  ...
  if (error) {
      ...
      console.log("✅ Migration V34 applied successfully via RPC!");
  }
}

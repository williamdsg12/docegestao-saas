...
async function applyMigration() {
  const sqlPath = path.join(__dirname, 'migration_v47_payment_delivery_type_tracking.sql');
  const sql = fs.readFileSync(sqlPath, 'utf8');
  console.log("Attempting to apply Migration V47...");
  ...
  if (error) {
      ...
      console.log("Copie o conteúdo do arquivo 'migration_v47_payment_delivery_type_tracking.sql' e");
      console.log("execute no editor SQL do Supabase (Supabase Dashboard > SQL Editor).");
      console.log("======================================================================\n");
      process.exit(0);
  } else {
      console.log("✅ Migration V47 applied successfully via RPC!");
  }
}

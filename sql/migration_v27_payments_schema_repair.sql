-- =================================================================
-- MIGRATION V27: REPAIR PAYMENTS SCHEMA & RPC ALIGNMENT
-- =================================================================

BEGIN;

-- 1. Add missing columns to public.payments
...
-- 2. Update RPC to copy values into both legacy and new columns
...
BEGIN
  ...
  -- 5. Create Payment (populated both legacy and new columns)

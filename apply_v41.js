...
async function applyMigration() {
  const sqlPath = path.join(__dirname, 'migration_v41_delivery_drivers.sql');
  const sql = fs.readFileSync(sqlPath, 'utf8');
  console.log("Attempting to apply Migration V41...");
  ...
  if (error) {
      ...
      console.log("Copie o conteúdo do arquivo 'migration_v41_delivery_drivers.sql' e");
      console.log("execute no editor SQL do Supabase (Supabase Dashboard > SQL Editor).");
      console.log("======================================================================\n");
      process.exit(1);
  } else {
      console.log("✅ Migration V41 applied successfully via RPC!");
  }
}

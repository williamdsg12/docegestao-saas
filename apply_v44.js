...
async function applyMigration() {
  const sqlPath = path.join(__dirname, 'migration_v44_operational_dashboard.sql');
  const sql = fs.readFileSync(sqlPath, 'utf8');
  console.log("Attempting to apply Migration V44...");
  ...
  if (error) {
      ...
      console.log("Copie o conteúdo do arquivo 'migration_v44_operational_dashboard.sql' e");
      console.log("execute no editor SQL do Supabase (Supabase Dashboard > SQL Editor).");
      console.log("======================================================================\n");
      process.exit(1);
  } else {
      console.log("✅ Migration V44 applied successfully via RPC!");
  }
}

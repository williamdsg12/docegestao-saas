...
async function applyMigration() {
    const sql = fs.readFileSync('migration_v28_secure_finance.sql', 'utf8');
    console.log("Attempting to apply Migration V28...");
    ...
    if (error) {
        ...
        console.log("Migration V28 applied successfully!");
    }
}

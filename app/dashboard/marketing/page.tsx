    ...
    <div className="p-6 md:p-10 space-y-12 min-h-screen pb-40">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex gap-4">
           <Button onClick={() => setIsCouponDialogOpen(true)} className="h-16 px-8 rounded-3xl bg-pink-500 text-white font-black uppercase text-[10px] tracking-widest flex gap-3 shadow-xl hover:bg-pink-600">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
         <div className="bg-slate-900 rounded-[48px] p-10 text-white relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-6">
               <div className="space-y-1">
                  ...
                  <h3 className="text-5xl font-black italic tracking-tighter">{coupons.filter(c => c.ativo).length}</h3>
               </div>
         ...
         <div className="bg-white rounded-[48px] p-10 border border-slate-100 shadow-xl relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-6">
               <div className="space-y-1">
                  ...
                  <h3 className="text-5xl font-black italic tracking-tighter text-slate-900">24%</h3>
               </div>
         ...
         <div className="bg-pink-50 rounded-[48px] p-10 border border-pink-100 relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-6">
               <div className="space-y-1">
                  ...
                  <h3 className="text-5xl font-black italic tracking-tighter text-pink-600">85</h3>
               </div>
            ...
            <Table>
               <TableHeader>
                  <TableRow className="border-slate-50 hover:bg-transparent">
                     <TableHead className="py-8 px-10 text-[10px] font-black uppercase tracking-widest text-slate-400">Código</TableHead>
                     <TableHead className="py-8 text-[10px] font-black uppercase tracking-widest text-slate-400">Tipo</TableHead>
                     <TableHead className="py-8 text-[10px] font-black uppercase tracking-widest text-slate-400">Benefício</TableHead>
                     <TableHead className="py-8 text-[10px] font-black uppercase tracking-widest text-slate-400">Usos</TableHead>
                     <TableHead className="py-8 text-right px-10 text-[10px] font-black uppercase tracking-widest text-slate-400">Ações</TableHead>
                  </TableRow>
               </TableHeader>
               <TableBody>
                  {coupons.map(coupon => (
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
         ...
         <div className="bg-white rounded-[56px] p-12 border border-slate-100 shadow-2xl space-y-10">
            <div className="flex items-center justify-between">
               <div className="space-y-1">
                  <h3 className="text-3xl font-black italic uppercase tracking-tighter text-slate-900">Catálogo de <span className="text-pink-500">Recompensas</span></h3>
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">O que suas clientes podem resgatar</p>
               </div>
               <Button className="size-14 rounded-2xl bg-pink-500 text-white shadow-xl hover:bg-pink-600"><Plus className="size-6" /></Button>
            </div>
            ...
            <div className="space-y-4">
               {rewards.length === 0 ? (
                  ...
                  rewards.map(reward => (
                     <div key={reward.id} className="p-8 rounded-[32px] bg-slate-50 border border-white flex items-center justify-between group hover:bg-white hover:shadow-xl hover:scale-[1.02] transition-all duration-500 cursor-pointer">
                        <div className="flex items-center gap-6">
                           <div className="size-16 rounded-[20px] bg-white shadow-sm flex items-center justify-center text-pink-500 group-hover:scale-110 transition-transform">
                              <Gift className="size-8" />
                           </div>
                           <div className="space-y-1">
                              <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Resgate com pontos</p>
                              <h4 className="text-xl font-black italic uppercase tracking-tighter text-slate-900 leading-none">{reward.nome}</h4>
                           </div>
                        </div>
                        <div className="bg-pink-500 h-10 px-6 rounded-full flex items-center justify-center text-white font-black uppercase text-[10px] tracking-widest shadow-lg shadow-pink-100">

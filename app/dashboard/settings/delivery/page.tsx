    ...
    <div className="space-y-8 p-4 md:p-10 pb-20">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 font-medium italic uppercase text-[10px] tracking-widest leading-relaxed">Configuração do Cálculo de Frete Profissional</p>
        </div>
      </div>

      <div className="max-w-4xl grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
        <Card className="rounded-[32px] md:rounded-[40px] border-none shadow-2xl shadow-slate-200/50 bg-white p-6 md:p-10 relative overflow-hidden">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <Input 
                    placeholder="5.00" 
                    className="h-14 md:h-16 pl-14 rounded-2xl bg-slate-50 border-none font-bold text-lg" 
        ...
        <div className="space-y-6 md:space-y-8">
           <Card className="rounded-[32px] md:rounded-[40px] border-none shadow-2xl shadow-slate-200/50 bg-white p-6 md:p-10">
             <CardContent className="p-0 space-y-6 md:space-y-8">
               ...
               <div className="space-y-6">
                 <div className="space-y-2">
                    ...
                    <Input 
                      placeholder="1.50" 
                      className="h-14 md:h-16 rounded-2xl bg-slate-50 border-none font-bold text-lg px-8" 
           ...
           <Button 
             disabled={saving}
             onClick={handleSave}
             className="w-full h-16 md:h-20 rounded-2xl md:rounded-[35px] bg-slate-900 hover:bg-slate-800 text-white font-black uppercase italic tracking-[0.2em] shadow-2xl transition-all active:scale-95 py-6 md:py-8"
           >
              {saving ? (
      ...
      <div className="max-w-4xl p-6 md:p-8 bg-blue-50 rounded-[32px] md:rounded-[40px] border border-blue-100 flex flex-col sm:flex-row gap-4 md:gap-6 items-center sm:items-start md:items-center">
         <div className="size-14 md:size-16 bg-white rounded-2xl md:rounded-3xl flex items-center justify-center text-blue-500 shadow-sm shrink-0">

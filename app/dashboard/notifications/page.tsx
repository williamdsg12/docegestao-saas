        ...
        <div className="space-y-10 pb-20">
            ...
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                        <BreadcrumbPage className="font-bold text-slate-900">Notificações</BreadcrumbPage>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <div className="flex items-center gap-3">
                    <Button
                        ...
                        className="rounded-full px-6 bg-slate-900 text-white hover:bg-primary transition-all text-[10px] font-black uppercase tracking-widest italic h-11 shadow-lg"
                    >
            ...
            <div className="flex flex-col md:flex-row gap-4">
                <div className="relative flex-1 group">
                    ...
                    <Input
                        ...
                        className="pl-12 h-14 rounded-2xl border-none shadow-xl shadow-slate-200/40 bg-white/70 backdrop-blur-md focus-visible:ring-primary/20 transition-all font-medium text-slate-600"
                    />
                </div>
            ...
            <div className="space-y-4">
                <AnimatePresence mode="popLayout">
                    {filteredNotifications.length > 0 ? (
                        ...
                        >
                            <div className="size-24 rounded-[40px] bg-white shadow-xl flex items-center justify-center border border-slate-100/50">
                                <BellOff className="size-10 text-slate-200" />
                            </div>
                            <div>
                                <h3 className="text-xl font-black text-slate-900 tracking-tighter uppercase italic">Silêncio total por aqui...</h3>
                            ...
                            <Button
                                ...
                                className="rounded-full px-8 text-[10px] font-black uppercase tracking-widest italic h-12"
                            >
                                Limpar filtros
                            </Button>
                        </motion.div>
